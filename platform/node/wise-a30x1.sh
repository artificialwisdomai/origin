###
#
# Definition of virtual environment: One A30s
#
# DO NOT RUN AS ROOT.
#
...
config_img="/var/lib/artificial_wisdom/cloudinit-config-wise-a30x1.img"
...
/usr/local/bin/virtiofsd-latest \
    --sandbox=none \
    --announce-submounts \
    --shared-dir=/run/artificial_wisdom/24-mounts/ \
...
/usr/local/bin/cloud-hypervisor \
	...
	--fs tag="homefs,socket=${virtiofs_sock},num_queues=1,queue_size=512" \
        ...
        --device path="/sys/bus/pci/devices/0000:24:00.0"
