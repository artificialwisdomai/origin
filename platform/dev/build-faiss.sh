...
LD_LIBRARY_PATH= MKLROOT=/opt/intel/oneapi/mkl/2023.1.0/ CXX=g++-11 cmake -B build -DBUILD_TESTING=ON -DFAISS_ENABLE_GPU=OFF              -DFAISS_OPT_LEVEL=axv2              -DFAISS_ENABLE_C_API=ON              -DCMAKE_BUILD_TYPE=Release              -DBLA_VENDOR=Intel10_64_dyn -Wno-dev .
