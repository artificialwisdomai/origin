# RETRO-pytorch testing

Using RETRO-pytorch from https://github.com/lucidrains/RETRO-pytorch
...
```sh
pyenv install 3.10
pyenv virtualenv 3.10 retro
pyenv local retro
```

Then you can install the prerequisites:
...
You can then test against a set of text documents that you add in ./text_folder/

```sh
python train.py
```

*NOTE*  The train.py app looks like the following. It was taken from the RETRO-pytorch readme and is not complete code but does run to completion on an A10 based GPU system.
